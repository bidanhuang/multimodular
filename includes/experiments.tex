...
the bottle's matching cap (see Fig.~\ref{fig:setup}).}
...
\begin{figure}
FIXME text should read ``to grasp'' not ``to grab'' (that's too
informal). %FIXME
  \centering
...
%FIXME again, you should cite the sensors & robots
...
% "Fig." is to show that "Fig" is abbreviated from "Figure".  "Figure."
...
% FIXME check:  I added the lambdas in here to reference back to
...
indeed effective in manipulation tasks. %JJB: "contextualized" is
...
\begin{figure*}
  ...
  \vspace{0.3cm}
  %\vspace{0.5cm}
  \subfloat[\scriptsize{Cap displacement.}]
  {\includegraphics[width=15cm]{./fig/demo_b4_s.eps}}

  \vspace{0.3cm}
  \hspace{-0.2cm}
  \subfloat[\scriptsize{Torque exerted against cap displacement.}]
...
FIXME --- fix the captions for the below as I already did for the
above. %FIXME
\begin{figure*}
  \centering
  \vspace{0.8cm}
  ...
  \vspace{0.3cm}
  %\vspace{0.5cm}
  \subfloat[\scriptsize{Exerted torque against cap displacement during the demonstration.}]
