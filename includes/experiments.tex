...
%JJB citations %JJB ---
%for a particular manipulation task: opening bottle caps. 
...
%informal). %JJB
  ...
  \caption{ \scriptsize{Experimental setup for the task of opening a
      ...
      with the cap to record its displacement. The bottle is
...
From this heatmap we can also see that within the same
...
\textcolor{red}{In these experiments, the %robot always choose to use
                                %JJB: robot is not the moral agent
